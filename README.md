...
- [Flix 0.51][flix_downloads] ([requires Java 21+][flix_compatibility])  ([*release notes*][flix_relnotes])
...
Tool versions:
   java 21.0.4, javac 21.0.4, scalac 2.13.15, flix v0.51.0,
   gradle 8.10.2, make 3.81, mdbook v0.4.40, mvn 3.9.9,
...
<a href="https://flix.dev/nightly/" rel="external">flix-2024-09-28.jar</a>                                <i>( 39 MB)</i>
...
<a href="https://git-scm.com/download/win" rel="external">PortableGit-2.46.2-64-bit.7z.exe</a>                   <i>( 46 MB)</i>
...
[flix]: https://flix.dev/
[flix_compatibility]: https://github.com/flix/flix/releases/tag/v0.51.0
[flix_downloads]: https://github.com/flix/flix/releases/
[flix_relnotes]: https://github.com/flix/flix/releases/tag/v0.51.0
